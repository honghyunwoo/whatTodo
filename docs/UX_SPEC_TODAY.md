...
1. Today 진입 시 핵심 카드(입력/실행/기록)에 집중
2. 필요 시 `학습 도우미` 펼치기
3. 복습/추천 카드 사용 후 다시 접기
...
- Section title: `학습 도우미`
- Description: `복습/추천 카드 3개`
- Toggle actions: `펼치기`, `접기`
- Persist: 마지막 토글 상태를 재진입/재실행 시 복원
...
6. Today 보조 카드가 기본 접힘이며 필요 시 1탭 확장 가능하다.
