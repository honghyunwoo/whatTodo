  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.section}>
        <Button title={isExporting ? '내보내는 중...' : '백업 내보내기'} onPress={handleExport} disabled={isExporting || isImporting} />
      ...
      <View style={styles.section}>
        ...
        />
        <Button title={isImporting ? '복원 중...' : '백업 불러오기'} onPress={handleImport} disabled={isImporting} />
        <Text style={styles.hint}>복원 후에는 앱을 재시작하거나 탭을 전환해 새 상태를 불러옵니다.</Text>
      </View>
    </ScrollView>
  );
}
